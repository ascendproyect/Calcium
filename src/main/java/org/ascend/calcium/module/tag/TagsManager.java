...
public class TagsManager {
    ...
    public void onLoad(){
        ...
        //Setup all tags from the YAML file:
    ...
    public void createTag(String identifier) {
        ...
        this.tags.add(new Tags(item, identifier, displayname, category, perm, equipped, equip, no_perm, tags.size()));
    }
    ...
    public void saveTag(String identifier) {
        ...
        config.set("tags." + identifier + ".data", tag.getItem().getData().getData());

...
@AllArgsConstructor
public class EditCategoryNameButton extends Button {
    Category category;
    ...
    public ItemStack getItemStack(Player player) {
        return ItemMaker.of(Material.ICE)
                ...
                .setLore(
                        ...
                        "&7name of this category.",
                        "",
                        "&6- &7Current Name: &a" + category.getName(),
                        "",
                        "&6Left-Click &7to edit this categories name."
                )
                .build();
    }
    ...
    public static class EditNamePrompt extends StringPrompt {
        ...
        public String getPromptText(ConversationContext conversationContext) {
            return ChatColor.GOLD + "[Calcium] " + ChatColor.YELLOW + "Please type the new name for the '" + ChatColor.WHITE + category.getName() + ChatColor.YELLOW + "' category. Type " + ChatColor.RED + "cancel" + ChatColor.YELLOW + " to cancel.";
        }
        ...
        public Prompt acceptInput(final ConversationContext conversationContext, final String input) {
            ...
            conversationContext.getForWhom().sendRawMessage(CC.translate("&6[Calcium] &aYou have successfully updated the name of " + this.category.getName() + " &ato &6" + input + "&a."));
            category.setName(CC.translate(input));
            new EditCategoryMenu(category).openMenu(sender.getPlayer());
